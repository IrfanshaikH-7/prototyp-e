...
const internetPlans = [
  ...
  },
  {
    ...
    speed: "1000",
    description: "Ultra-fast speeds for households with multiple users.",
  },
]
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-6">
            {internetPlans.map((plan) => (
              <div key={plan.name} className="space-y-4 flex flex-col items-center group">
                ...
                <button className="bg-bluvy w-[80%]  text-white px-6 py-2 rounded-full hover:bg-bluvy hover:-rotate-2 group-hover:shadow-xl transition-all duration-300">
        ...
        <TabsContent value="tv">
          <div className="grid md:grid-cols-3 gap-6 mt-6">
            {tvPackages.map((package_) => (
                <div key={package_.name} className="space-y-4 flex flex-col items-center group">
                <div className='border rounded-2xl p-6 text-center group-hover:shadow-xl'>
